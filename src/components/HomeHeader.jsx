  ...
  return (
    <View className="px-3 pt-5 pb-2 flex-row  justify-between items-center">
     ...
     <View className='flex justify-center flex-row items-baseline'>
        <Text className="text-dark_blue text-2xl font-mulish_exbold">AXIO </Text>
        <Text className="text-dark_blue text-base font-mulish_medium">Life</Text>
     </View>
     
     <Pressable className='relative pr-3' onPress={()=>navigation.navigate('Cart')}>
